...
public class DijkstraAlgorithm {
	...
	private float getDistance(Vertex node, Vertex target) {
		for (Edge edge : edges) {
			if (edge.getSource().equals(node)
				...
				return edge.getTransmission_time();
			}
		}
	...
	float getShortestDistance(Vertex destination) {
	...
	private Vertex getMinimum(Set<Vertex> vertexes) {
		...
		PriorityQueue < Vertex >  prq = new PriorityQueue < Vertex >(vertexes.size(),Vertex.vertexDistanceComparator);
